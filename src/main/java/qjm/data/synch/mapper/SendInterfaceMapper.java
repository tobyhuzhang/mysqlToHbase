...
public interface SendInterfaceMapper {
     TspVehicleConditionDO getDataByVin(String vin);

     TemperatureRecordDO getTemp(String deviceNumber);

     TspVehicleConditionDO getHisBeforeToday(Map<String, String> paramMap);

     Float calPath(Map<String, String> paramMap);

     Float getTotalDistanceByVin(String vin);

     List<TspVehicleConditionDO> getTSPDataByVin(Map<String, String> queryMap);

     VehicleDO getVehicleByVin(String vin);

     List<DeviceVinDO> getDeviceVinByVin(String vin);
