...
@Family("option")
public class TemperatureRecord extends HbaseSerializationReflect<TspCompleteCondition> {
	/**
	 * 
	 */
	public Integer id;
	...
	private Integer electricity;//电量P005
	private Integer maxStrength;//信号强度P013
	private Integer deviceType;//用于判断是哪个公司的温湿度设备
	...
	@Override
	public byte[] getKey() {
		return Bytes.toBytes(vin+"."+timestamp.getTime()/1000);
	}
}
